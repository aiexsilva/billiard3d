...
void main() {
    ...
    uMaterial.ambient = vec3(0.1, 0.1, 0.1);
    uMaterial.diffuse = vec3(1.0, 1.0, 1.0);
    uMaterial.specular = vec3(0.12, 0.12, 0.12);
    uMaterial.shininess = 2.5;
